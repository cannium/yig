...
func newGetObjectResponseWriter(w http.ResponseWriter, r *http.Request, object *meta.Object, hrange *HttpRange, version string) *GetObjectResponseWriter {
	return &GetObjectResponseWriter{false, w, r, object, hrange, version}
}
...
func (o *GetObjectResponseWriter) Write(p []byte) (int, error) {
	if !o.dataWritten {
		...
		SetObjectHeaders(o.w, o.object, o.hrange)
...
func (api ObjectAPIHandlers) GetObjectHandler(w http.ResponseWriter, r *http.Request) {
	...
	writer := newGetObjectResponseWriter(w, r, object, hrange, version)
